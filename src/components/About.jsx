        ...
        <div className="items-center lg:flex">
          <div className="lg:w-1/2">
            ...
            <p className="mt-4 text-gray-500 dark:text-gray-400 lg:max-w-md">
              Hi! I'm Steve, entrepreneur and front-end developer lead
              <a
              ...
              Gatsby starter for Tailwindscss expanded with css-in-JS using
              twin, and built-in support for GSAP. When will it be completed?
              I'm targeting September 9, 2021.
            </p>
            ...
            <div className="flex items-center mt-6 -mx-2">
              ...
              <a
                className="mx-2"
                href="https://www.facebook.com/sparky888/"
                aria-label="Facebook"
              >
                <svg
                  className="w-5 h-5 text-gray-700 fill-current dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400"
