      ...
      <Layout>
        <OuterWrapper>
          <InnerWrapper>
            ...
            <ButtonWrapper>
              <Button1>
                <Button1Style to="../coastal-florida-photography">
                  Next Gallery
                </Button1Style>
              </Button1>
              <Button2>
                <Button2Style to="../hurricane-larry-photography">
                  Previous Gallery
                </Button2Style>
              </Button2>
            </ButtonWrapper>
...
query {
  gallery: contentfulGallery(galleryName: {eq: "Real Estate and Art Photography"}) {
    id
    galleryName
    galleryDescription {
      childMdx {
